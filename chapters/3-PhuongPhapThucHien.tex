...
\end{itemize}
\subsection{Giả lập phương tiện}
...
\begin{figure}[!htp]
    ...
    \begin{subfigure}[b]{0.45\textwidth}
        ...
        \caption{PhânHai nhóm làn đường}
...
% \subsection{Training mô hình DRL}

% \begin{figure}[!htp]
%     \centering
%     \includegraphics[width=\textwidth]{img/training_flow.png}
%     \caption{Sơ đồ quá trình training cho mô hình DRL}
