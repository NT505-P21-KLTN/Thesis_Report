...
\footnotesize % hoặc \footnotesize, \scriptsize tùy ý
...
\textbf{Balanced} & \textbf{0,0007} & \textbf{64} & \textbf{0,9} & \textbf{200} & \textbf{50000} & \textbf{0,9→0,05} & \textbf{400} \\
...
Hình \ref{fig:sync_learning_curves} minh họa các khuôn mẫu học tập khác biệt giữa hai mô hình: Mô hình phần thưởng dương cho thấy các chu kỳ rõ ràng giữa phản hồi tích cực và tiêu cực, trong khi mô hình phần thưởng âm thể hiện một đường cong học tập ổn định hơn.
...
Dựa trên bảng \ref{tab:sync_performance_comparison}, có thể thấy rằng mỗi mô hình đều có những ưu và nhược điểm. Về phần thưởng, mô hình phần thưởng dương có hiệu suất tốt hơn với phần thưởng tốt nhất là +1.253, phần thưởng cuối cùng là -254 và phần thưởng trung bình là +106. Tuy nhiên, mô hình này có độ lệch chuẩn phần thưởng cao hơn, lên tới 471, cho thấy độ biến động lớn. Về thời gian chờ, mô hình phần thưởng âm có ưu thế hơn. Thời gian chờ trung bình tốt nhất của mô hình này là 141 giây, và thời gian chờ trung bình cuối cùng là 158 giây, ngắn hơn so với mô hình phần thưởng dương. Xét về tính ổn định, mô hình phần thưởng âm cũng có lợi thế hơn. Số tập có cải thiện liên tục ở mô hình này, trong khi mô hình phần thưởng dương chỉ có 97 tập cải thiện. Điều này cho thấy mô hình phần thưởng âm ổn định hơn. Về hiệu suất tối đa, mô hình phần thưởng âm lại vượt trội hơn khi đạt hiệu suất cao nhất ở tập 89, trong khi mô hình phần thưởng dương chỉ đạt hiệu suất cao nhất ở tập 58. Như vậy, mô hình phần thưởng âm có ưu điểm về thời gian chờ trung bình, độ ổn định và có thể đạt hiệu suất cao hơn.
...
\begin{table}[!htp]
    ...
    \begin{tabular}{@{}lcccc@{}}
        \toprule
        \textbf{Phương pháp} & \textbf{Avg Wait Time (s) } & \textbf{ Queue Length } & \textbf{ Cải thiện } & \textbf{ Nguồn } \\
        \midrule
        Fixed-time Control & 45,0 & 9,5 & 0\% & \\
        Actuated Control & 42,1 & 8,7 & 6,4\% & \\
        Optimized Fixed-time & 39,8 & 8,1 & 11,6\% & \\
        DQN Single Agent (Balanced) & 38,5 & 8,5 & 14,3\% & \\
        \textbf{DQN + Sync Agent} & \textbf{32,9} & \textbf{7,3} & \textbf{27,0\%} & \\
        \bottomrule
    \end{tabular}
\end{table}
...
\begin{itemize}
    \item Sync Agent đạt hiệu suất vượt trội nhất với cải thiện 27.0\% 
...
\begin{table}[!htp]
    ...
    \begin{tabular}{@{}lcccc@{}}
        \toprule \textbf{Tình huống} & \textbf{Phương pháp} & \textbf{Thời gian chờ (s)} & \textbf{Độ dài hàng đợi (xe)} & \textbf{Mật độ (xe/h)} \\
        \midrule 
...
% \begin{itemize}
%             \item \texttt{single\_intersection\_model.h5} - DQN đa mục đích (cải thiện 14,3\%)
